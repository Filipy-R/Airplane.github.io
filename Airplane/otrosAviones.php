...
// Obtener todos los modelos de aviones de otros fabricantes
...
<head>
    ...
    <title>Otros modelo | FlightAir</title>
    <link rel="stylesheet" href="../WebSite/Includes/Style/modelAirplane.css">
</head>
<body>
    <main>
        <h1 class="title-modelos" id="titulo-boeing">Modelos de Aviones </h1>
